...
docker rmi quay.io/qiot/qiot-datahub-query
docker build -f src/main/docker/Dockerfile.native -t quay.io/qiot/qiot-datahub-query .
docker push quay.io/qiot/qiot-datahub-query
